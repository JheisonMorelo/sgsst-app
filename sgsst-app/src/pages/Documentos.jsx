...
import { ScrollText, Archive, Check, Zap } from '../components/icons';
        ...
        {CATEGORIAS.map(c => (
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-sm transition-colors flex items-center gap-1.5 ${
              categoriaActiva === c
                ? c === 'Eléctrico' ? 'bg-yellow-500 text-white' : 'bg-blue-600 text-white'
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    <span className={`badge text-xs flex items-center gap-1 ${doc.categoria === 'Eléctrico' ? 'bg-yellow-100 text-yellow-700' : 'bg-slate-100 text-slate-600'}`}>
